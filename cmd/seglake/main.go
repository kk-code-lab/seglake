...
func newServerFlagSet() (*flag.FlagSet, *serverOptions) {
	...
	fs.StringVar(&opts.corsHeaders, "cors-headers", "authorization,content-md5,content-type,x-amz-date,x-amz-content-sha256,x-amz-server-side-encryption,x-amz-server-side-encryption-aws-kms-key-id,x-amz-tagging,x-amz-tagging-directive", "Comma-separated CORS allowed headers")
