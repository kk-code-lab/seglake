...
- [api][research] Implement the SSE-S3 key-provider interface from `docs/key-provider-rfc.md`; keep phase 1 local-only, then evaluate Vault Transit as the first external backend.
