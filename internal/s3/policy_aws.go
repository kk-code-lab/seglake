...
var awsActionToPolicy = map[string]string{
	...
	"getbucketencryption":           policyActionGetBucketEncryption,
	"putbucketencryption":           policyActionPutBucketEncryption,
	"deletebucketencryption":        policyActionDeleteBucketEncryption,
	"getencryptionconfiguration":    policyActionGetBucketEncryption,
	"putencryptionconfiguration":    policyActionPutBucketEncryption,
	"deleteencryptionconfiguration": policyActionDeleteBucketEncryption,
	"getbucketlifecycle":            policyActionGetBucketLifecycle,
	"putbucketlifecycle":            policyActionPutBucketLifecycle,
	"deletebucketlifecycle":         policyActionDeleteBucketLifecycle,
	"getlifecycleconfiguration":     policyActionGetBucketLifecycle,
	"putlifecycleconfiguration":     policyActionPutBucketLifecycle,
	"deletelifecycleconfiguration":  policyActionDeleteBucketLifecycle,
	"getobject":                     policyActionGetObject,
	"headobject":                    policyActionHeadObject,
	"getobjecttagging":              policyActionGetObjectTagging,
	"putobjecttagging":              policyActionPutObjectTagging,
	"deleteobjecttagging":           policyActionDeleteObjectTagging,
	"getobjectversiontagging":       policyActionGetObjectTagging,
	"putobjectversiontagging":       policyActionPutObjectTagging,
	"deleteobjectversiontagging":    policyActionDeleteObjectTagging,
