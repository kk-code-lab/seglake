...
type OpsRunRequest struct {
	...
	ManifestGCTTLNanos int64   `json:"manifest_gc_ttl_nanos,omitempty"`
	ManifestGCPlan     string  `json:"manifest_gc_plan,omitempty"`
	ManifestGCFromPlan string  `json:"manifest_gc_from_plan,omitempty"`
	ManifestGCForce    bool    `json:"manifest_gc_force,omitempty"`
